    ...
    public partial class DatosDePrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 11, 13, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 11, 6, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 11, 11, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 11, 6, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
            ...
            migrationBuilder.InsertData(
                table: "SalasCines",
                columns: new[] { "Id", "CineId", "Precio", "TipoSala" },
                values: new object[,]
                {
                    { 1, 1, 220m, 1 },
                    { 2, 1, 320m, 2 },

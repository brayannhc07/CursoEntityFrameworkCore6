...
namespace EFCorePeliculas.Controllers {
	...
	public class GenerosController: ControllerBase {
		...
		public async Task<ActionResult<Genero>> Get( int id ) {
			var genero = await context.Generos.FirstOrDefaultAsync( genero => genero.Identificador == id );
		...
		public async Task<ActionResult<Genero>> Primer() {
			var genero = await context.Generos.FirstOrDefaultAsync( genero => genero.Nombre.StartsWith( "C" ) );

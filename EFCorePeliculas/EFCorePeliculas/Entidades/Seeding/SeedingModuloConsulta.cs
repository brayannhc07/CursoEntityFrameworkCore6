	...
	public class SeedingModuloConsulta {
		public static void Seed( ModelBuilder modelBuilder ) {
			...
			var salaDeCine2DAgora = new SalaCine() {
				...
				CineId = agora.Id,
				Precio = 220,
				TipoSala = TipoSalaCine.DosDimensiones
			};
			var salaDeCine3DAgora = new SalaCine() {
				Id = 2,
				CineId = agora.Id,
				Precio = 320,
				TipoSala = TipoSalaCine.TresDimensiones
			};
			...
			var salaDeCine3DSambil = new SalaCine() { Id = 4, CineId = sambil.Id, Precio = 290, TipoSala = TipoSalaCine.TresDimensiones };


			var salaDeCine2DMegacentro = new SalaCine() { Id = 5, CineId = megacentro.Id, Precio = 250, TipoSala = TipoSalaCine.DosDimensiones };
			var salaDeCine3DMegacentro = new SalaCine() { Id = 6, CineId = megacentro.Id, Precio = 330, TipoSala = TipoSalaCine.TresDimensiones };
			var salaDeCineCXCMegacentro = new SalaCine() { Id = 7, CineId = megacentro.Id, Precio = 450, TipoSala = TipoSalaCine.CXC };

			var salaDeCine2DAcropolis = new SalaCine() { Id = 8, CineId = acropolis.Id, Precio = 250, TipoSala = TipoSalaCine.DosDimensiones };
